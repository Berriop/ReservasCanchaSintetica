...
using RerservasCanchaSintetica.Modelos;
using System;

namespace RerservasCanchaSintetica.Modelos
{
    [TestClass]
    public class ReservaCanchaSinteticaTests
    {
        ...
        public class CanchaTests
        {
            ...
            {
                var cancha = new Cancha { PrecioPorHora = 50.0f };
            ...
            {
                var cancha = new Cancha { PrecioPorHora = -10.0f };
