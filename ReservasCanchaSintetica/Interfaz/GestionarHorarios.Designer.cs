namespace ReservasCanchaSintetica
{
    partial class GestionarHorarios
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Location = new Point(305, 63);
            label1.Name = "label1";
            ...
            // datetime_fecha
            // 
            datetime_fecha.Format = DateTimePickerFormat.Short;
            datetime_fecha.Location = new Point(635, 144);
            datetime_fecha.Margin = new Padding(3, 4, 3, 4);
            datetime_fecha.Name = "datetime_fecha";
            datetime_fecha.Size = new Size(228, 27);
            datetime_fecha.TabIndex = 0;
            // 
            // button1
            // 
            button1.Font = new Font("Arial", 14F, FontStyle.Bold);
            button1.Location = new Point(113, 264);
            ...
            button2.Location = new Point(582, 264);
